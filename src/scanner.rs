...
macro_rules! for_each_rule {
    ($callback:ident) => {
        $callback! {
            ...
            (prefer_g_object_class_install_properties, PreferGObjectClassInstallProperties, 2, 26),
            (prefer_g_settings_typed, PreferGSettingsTyped, 2, 26),
            (prefer_g_value_set_static_string, PreferGValueSetStaticString, 2, 0),
